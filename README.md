<h3 align="center">Anglais Facile Open Source</h3>
<p align="center">
...
- Remarque : il existe une application Firebase non maintenue et obsolète que vous pourriez trouver lors d'une recherche dans OSSU. Vous pouvez l'ignorer en toute sécurité. En savoir plus dans la [FAQ](./FAQ.md#why-is-the-firebase-ossu-app-différent-or-broken).

# Programme d'études

**Version du programme** : `8.0.0` (voir [CHANGELOG](CHANGELOG.md))
